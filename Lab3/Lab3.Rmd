...
Visually we can say that the samples that we got from the inverse CDF follow the distribution of the Laplace distribution
...
We can see that the samples that we obtained follow the ditribution
